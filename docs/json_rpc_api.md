...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/lbrycrd.go/btcwallet).
...
[btcrpcclient](https://github.com/lbrycrd.go/btcrpcclient) package.
...
[btcrpcclient](https://github.com/lbrycrd.go/btcrpcclient) package to connect with
...
import (
	"github.com/lbrycrd.go/btcrpcclient"
