...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr lbcutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*lbcutil.Tx, error) {
...
func CreateBlock(prevBlock *lbcutil.Block, inclusionTxs []*lbcutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr lbcutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*lbcutil.Block, error) {
	...
	blockTxns := []*lbcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := lbcutil.NewBlock(&block)
