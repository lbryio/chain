...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*lbcutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []lbcutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (lbcutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() lbcutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*lbcutil.Tx, blockVersion int32,
	blockTime time.Time) (*lbcutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*lbcutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*lbcutil.Block, error) {
	...
	prevBlock := lbcutil.NewBlock(mBlock)
