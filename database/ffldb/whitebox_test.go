...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*lbcutil.Block, error) {
	...
	blocks := make([]*lbcutil.Block, 0, 256)
	genesis := lbcutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
