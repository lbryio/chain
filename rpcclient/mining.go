...
func (c *Client) SubmitBlockAsync(block *lbcutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *lbcutil.Block, options *btcjson.SubmitBlockOptions) error {
