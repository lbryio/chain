...
func GetBlockWeight(blk *lbcutil.Block) int64 {
...
func GetTransactionWeight(tx *lbcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *lbcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
