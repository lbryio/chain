...
func (b *BlockChain) FetchSpendJournal(targetBlock *lbcutil.Block) ([]SpentTxOut, error) {
	b.chainLock.RLock()
...
func dbFetchSpendJournalEntry(dbTx database.Tx, block *lbcutil.Block) ([]SpentTxOut, error) {
...
func (b *BlockChain) initChainState() error {
	...
	err = b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(lbcutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a lbcutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*lbcutil.Block, error) {
...
func dbStoreBlock(dbTx database.Tx, block *lbcutil.Block) error {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int32) (*lbcutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*lbcutil.Block, error) {
