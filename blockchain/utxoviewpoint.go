...
func (view *UtxoViewpoint) AddTxOut(tx *lbcutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *lbcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *lbcutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *lbcutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *lbcutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *lbcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *lbcutil.Tx) (*UtxoViewpoint, error) {
