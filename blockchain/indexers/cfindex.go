...
func storeFilter(dbTx database.Tx, block *lbcutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *lbcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *lbcutil.Block,
